...
UI
	...
	•	All tailwind classes should be used with clsx and cn from @/lib/utils.ts
Routing
	•	NEVER USE FILE ROUTES, ONLY CODED ROUTES WITH TANSTACK ROUTER
	•	If no router exists, implement (or for static hosting) in src/main.tsx wrapping the App.
	•	Define routes in a centralized src/routes.tsx using createBrowserRouter for advanced features like 
	code-splitting.
...
Component Splitting and Patterns
	...
	•	Follow this component pattern:import { SomeType } from 'some-package';
	•	
