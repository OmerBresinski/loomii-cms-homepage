    ...
    <div className="min-h-[calc(100vh-4rem)]">
      ...
      <section id="features" className="py-24 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <FeatureCard step="01" title="Connect" description="Link your GitHub repo and live deployment URL." />
            <FeatureCard step="02" title="Analyze" description="AI scans your site and identifies editable content." />
            <FeatureCard step="03" title="Edit & Ship" description="Make changes visually and ship as a pull request." />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-6 text-center relative">
          ...
          <p className="text-gray-400 mb-8">Join teams shipping content faster with AI-powered editing.</p>
          <SignedOut>
            <SignInButton mode="modal" forceRedirectUrl="/onboarding">
...
function FeatureCard({ step, title, description }: { step: string; title: string; description: string }) {
  return (
    <div className="p-8 border border-white/10 rounded-lg bg-[#111] hover:bg-[#161616] transition-colors group">
      <div className="text-4xl font-bold text-white/10 group-hover:text-white/20 transition-colors mb-4">{step}</div>
